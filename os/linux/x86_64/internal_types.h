...
typedef struct {
    long long int ll __attribute__((__aligned__(__alignof__(long long))));
...
#define __INT64_LIT(n)      n ## L
#define __UINT64_LIT(n)     n ## UL
...
#define __INTWORD_LIT(n)    n ## L
#define __UINTWORD_LIT(n)   n ## UL
