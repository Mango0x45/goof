/**
 * =======================================================
 * os/win/x86/internal_types.h: internal type definitions.
 * =======================================================
...
#define __INTERNAL_TYPES_H "os/win/x86/internal_types.h"

#include "arch_defs.h"

#ifndef __ILP32__
#error "Wrong internal_types.h file! Currently using win/x86."
#endif
...
typedef signed long long int __sint64_t;
typedef unsigned long long int __uint64_t;

typedef signed long long int __sintmax_t;
typedef unsigned long long int __uintmax_t;

typedef signed int __sintptr_t;
typedef unsigned int __uintptr_t;

typedef signed int __sintword_t;
typedef unsigned int __uintword_t;
...
# define __INTWORD_MAX      (2147483647)
# define __INTWORD_MIN      (-2147483648)
# define __UINTWORD_MAX     (4294967295U)
