...
#define __INTERNAL_TYPES_H "os/win/x86_64/internal_types.h"

#include "arch_defs.h"

#ifndef __LLP64__
#error "Wrong internal_types.h file! Currently using win/x86_64."
#endif
...
typedef signed long long int __sintptr_t;
typedef unsigned long long int __uintptr_t;

typedef signed long long int __sintword_t;
typedef unsigned long long int __uintword_t;
